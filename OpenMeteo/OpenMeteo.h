...
***************************************************************************************/
class OM_Weather: public JsonListener {
  ...
  public:
    ...
    bool getForecast(SOM_weather *weather, String latitude, String longitude, bool secure = true);
  ...
  private: // Variables used internal to library
    ...
    uint16_t hourly_index;   // index into the OM_hourly structure's data arrays
    uint16_t daily_index;    // index into the OM_daily structure's data arrays
    ...
    SOM_weather *weather;   // pointer provided by sketch to the OM_ struct
